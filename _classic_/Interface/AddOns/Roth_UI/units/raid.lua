...
if not cfg.units.raid.show then
  ...
  local createHealthPowerStrings = function(self)
    ...
    local name = func.createFontString(self, cfg.font, 12, "THINOUTLINE", "ARTWORK")
    ...
    local hpval = func.createFontString(self, cfg.font, 11, "THINOUTLINE", "OVERLAY")
  ...
  local function createStyle(self)
    ...
    --icons
    self.RaidIcon = func.createIcon(self,"OVERLAY",14,self.Health,"CENTER","CENTER",0,0,-1)
	...
	self.Leader = func.createIcon(self,"OVERLAY",14,self.Name,"TOPLEFT","TOPLEFT",-7,-10,0)
